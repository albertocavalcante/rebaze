...
<Aside type="tip">
**Best Practices:**
1. Always configure CMake before migration
2. Match configurations between CMake and rebaze
3. Use `--cmake-file-api-only` in CI for consistency
</Aside>
